...
meta:
	ADDON_NAME = ofxCvGui2
	ADDON_DESCRIPTION = Version 2 of the ofxCvGui addon
	ADDON_AUTHOR = Elliot Woods
	ADDON_TAGS = "gui" "panels" "object oriented"
	ADDON_URL = http://github.com/elliotwoods/ofxCvGui2

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxLiquidEvent ofxGrabCam


	ADDON_DEFINES = HAS_OFXCVGUI
